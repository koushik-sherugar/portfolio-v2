      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            As senior software engineer, I worked on building scalable web
            applications for enterprise clients. handling millions of users
          </p>
          ...
          <ul className="list-disc pl-4">
            ...
            <li className="text-neutral-700 dark:text-neutral-300 text-xs md:text-sm">
              Built a scalable search engine for real estate listings
            </li>
            <li className="text-neutral-700 dark:text-neutral-300 text-xs md:text-sm">
              Migrated the upnest.com aquired by them with latest tech stack.
            </li>
          </ul>
          <HoverEffect items={HoverEffectImages.tavant} />
        </div>
      ),
    },
    {
